...
const auth = new google.auth.GoogleAuth({
    credentials: {
        ...
        private_key: process.env.GOOGLE_PRIVATE_KEY,  // Reemplazar \\n por \n
...
const spreadsheetId = '1uJNDaqfwcudtflbkp9Pmbtvyx6T_AkshvNDZvR5XAo8'; // ID de tu hoja de cálculo.
...
async function appendToSheet(values) {
    const sheets = google.sheets({ version: 'v4', auth }); // Crea una instancia cliente de la API de Sheets.
    const range = 'Mensajeria!A3'; // El rango en la hoja para empezar a agregar datos.
    const valueInputOption = 'USER_ENTERED'; // Cómo se deben interpretar los datos de entrada.
